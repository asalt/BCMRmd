...
params:
  ...
  paramfile:
    value: "../../MSPC000936/MSPC000936_BCMRmd.yaml"
  projectid:
    value:
      "MSPC001012"
  ROOTPATH:
...
.species_filter <- modi_gct_merged@rdesc %>% dplyr::filter(TaxonID=="9606")
...
```{r, label='modi-alldata-prof-heatmap-names', fig.height=475, fig.width=12, include=F, eval=F}
